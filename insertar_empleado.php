...
<font color="#000000"><div class="adsi-css" style="auto"> 
				...
				<br>
  <br>
			 <form method="post" action="insertar/insertar_empleado_empleados.php"enctype="multipart/form-data">
			 
			 <center>
	<h4><p class="p" style="color: black">información empleado

			 &nbsp;&nbsp;&nbsp;&nbsp;
			 <br></h4>
			 </center>
 <h6><p class="l" style="color: black" >
...
<input type="text" name="trabajo" required>
 ...
 <h4><p class="p" style="color: black">datos de ingreso a la pagina &nbsp;&nbsp;&nbsp;&nbsp;<br>
			 <br></h4>
			 <h6><p class="l" style="color: black" >
ingrese contraceña previa:&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="contra" required>
 <br><br><br>
 <h6><p class="l" style="color: black" >
ingrese ¿nombre del color preferido?:&nbsp;&nbsp;&nbsp;&nbsp;
