...
<img src="../images/INVENTARIO_lista.png" width="900">  
						<br>       
						<br>      
		...
		<a href="insertar_inventario.php"><button type="button" title="Agrega un nuevo plato" class="anadir">Agrega un nuevo producto</button></a><br><br><br>
...
<font color="#000000"><div class="adsi-css" style="auto"> 
				...
				<!--=======tablas================-->   
				<table class="table1">
			<?php include "tablas/inventario.php";?>
					   </table>
				</header>
					</font>
