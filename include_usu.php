...
if ( $archivo=="About_usu.php") 
{ $c0="current"; }
if ($archivo=="menu_usu.php")
{ $c1="current"; }
if ($archivo=="contacto_usu.php")
{ $c2="current"; }
				...
				<div class="grid_12">
					...
					<nav>
						<ul class="sf-menu">
								...
								<li class="<?php echo $c0;?>"><a href="<?php echo $ruta;?>About_usu.php">Info</a></li>		
								<li class="<?php echo $c1;?>"><a href="<?php echo $ruta;?>menu_usu.php">Menu</a><ul>
										
											<li><a href="vista/menu_usu.php#Sopas">Sopas</a></li>
											<li><a href="vista/menu_usu.php#Entradas">Entradas</a></li>
											<li><a href="vista/menu_usu.php#Bebidas">Bebidas</a></li>
											
											
										</ul></li>
							
							<li class="<?php echo $c2;?>"><a href="<?php echo $ruta;?>contacto_usus.php">Contactenos</a></li>
