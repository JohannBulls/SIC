...
<div class="grid_1">
 ...
 <a href="About_usu.php"> <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">  <img src=../images/FLECHA.PNG width=50 height=50px></button></a>
...
Teléfono:
 ...
 <br>
 Contraseña:</h7>
 <input type="password" name="password" class="adsi-css" style="width:100px; height:30px" required value="<?php echo $reg['password'];?>">
 <br>
