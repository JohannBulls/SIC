...
<section id="content">
	...
	<div class="full-width-container block-2">
		<div class="container">
			<div class="row">
               ...
               <table>
               <tr><td>
					<form id="contact-form" method="post" action="insertar_contacto.php">
   ...
   <h7>Nombre </h7><input type="nombre" id="nombre" name="nombre"  class="adsi-css" placeholder="Nombre" required/><br/>
      ...
      <br>
      <h7>Asunto   </h7>    
      <input type="text" id="asunt" name="asunto"  class="adsi-css" placeholder="Asunto" required/><br/>
      <br>
      <h7>Mensaje </h7>   
      <br>
      <br>
      <textarea style="width:400px; height: 120px;" id="text" name="texto" class="adsi-css"  placeholder="Mensaje" required></textarea>
      <br>
      <input type="submit"  button class="btn btn-lg btn-primary btn-block btn-sm"  style="width:290px" required>
       <br>
         	</form>
					</td><td>
				</div>
