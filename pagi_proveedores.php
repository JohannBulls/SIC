...
<img src="../images/proveedores_lista.png" width="900">  
		...
		<a href="insertar_proveedor.php"><button type="button" title="Agrega un nuevo plato" class="anadir">Agrega un nuevo proveedor</button></a>
			<br>
			<br>
			<br>
			
		
<div class="adsi-css" style="auto"> 

				<!--=======tablas================-->  
				<table class="table1" >
			<?php include "tablas/proveedor.php";?>
					   </table>
			</header>
